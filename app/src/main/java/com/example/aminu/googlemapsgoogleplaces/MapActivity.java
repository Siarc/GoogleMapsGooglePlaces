...
import com.example.aminu.googlemapsgoogleplaces.models.PlaceInfo;
...
/**
 * Created by aminu on 10/28/2017.
 */
    ...
    private void getDeviceLocation(){
        ...
        try {
            if (mLocationPermissionsGranted){
                ...
                Task location = mFusedLocationProviderClient.getLastLocation();//there is two of the same looking import for Task: CARE
